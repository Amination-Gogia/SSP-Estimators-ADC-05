...
MODEL                   = configuring_inputs
MODULES                 = configuring_inputs_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\configuring_inputs_msf.mexw64
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:configuring_inputs_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
configuring_inputs_msf.obj : $(START_DIR)\slprj\sim\configuring_inputs\configuring_inputs_msf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\sim\configuring_inputs\configuring_inputs_msf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\configuring_inputs\configuring_inputs_msf.c
