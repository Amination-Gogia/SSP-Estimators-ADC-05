...
class KalmanFilter:
    ...
    def update(self, Gyro, Acc, dt):
        ...
        KalmanGain = self.KalmanUncertainity/(self.KalmanUncertainity + 1*1*dt*dt)
...
class MPU6050:
    def __init__(self, busid, SDA, SCL, led=25):
        ...
        self.pitchAngle = KalmanFilter(self.KalmanStateX, self.KalmanUncertainityX)

        self.KalmanStateY = 0
        self.KalmanUncertainityY = 0
        self.rollAngle = KalmanFilter(self.KalmanStateY, self.KalmanUncertainityY)
